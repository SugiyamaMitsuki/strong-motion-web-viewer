...
export function ExportPanel({ waveforms, responseSettings, peaks, intensity }: ExportPanelProps): JSX.Element {
  ...
  return (
    <section className="panel">
      ...
      <p className="note">Export time histories, Fourier spectra, H/V spectral ratios, response spectra, and summaries as CSV/JSON/ZIP. Use the buttons on each chart to export PNG or SVG figures.</p>
      <div className="button-row wrap">
        ...
        <button type="button" disabled={disabled} onClick={() => downloadTextFile('fourier_acceleration.csv', buildFourierCsv(waveforms, 'acceleration'), 'text/csv;charset=utf-8')}>Fourier CSV</button>
